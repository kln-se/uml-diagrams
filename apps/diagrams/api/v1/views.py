...
from apps.diagrams.api.v1.serializers import DiagramSerializer, DiagramCopySerializer
...
@extend_schema(
    ...
    description='This API endpoint allows you to create a copy of an existing diagram. '
                'The new diagram will have the same content as the original, but a different title.',
    responses={
